...
- SSW101B - Seems to be a wifi chip, maybe based on the same core as the XR819. See [xradio](https://github.com/fifteenhex/xradio). [Driver code](https://github.com/fifteenhex/sigmastar-ssw101b-driver)
