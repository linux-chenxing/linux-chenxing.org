...
For now let's worry about pm51. So far this has only been confirmed in the infinity3. The infinity2 and infinity6b don't seem to have
the "mcu" registers at the same place.
